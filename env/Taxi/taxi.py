...
class TaxiEnv(Env):
    ...
    * v0: Initial version release
    ...
    def get_events(self):
        #if passenger in taxi return event ("picked")
        props=()
    ...
    def reset(
        ...
        *,
        ...
        # Fixed starting state for easier debugging, passenger at Red, destination Blue
        taxi_row, taxi_col = 2, 2
        pass_idx = 0  # Red location
        dest_idx = 3  # Blue location
...
#     id='CustomTaxi-v0',
#     entry_point='taxi:TaxiEnv',  # assuming your file is taxi.py
#     kwargs={'render_mode': 'rgb_array'},  # Specify render mode here
#     max_episode_steps=200,
# )

# # Now you can use gym.make()
# env = gym.make('CustomTaxi-v0', render_mode='rgb_array')
# obs = env.reset()
# print(env.unwrapped.get_events())
